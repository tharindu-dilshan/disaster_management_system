<?php
	...
	if (isset($_POST['page']))
		...
		$page = 1;
		$sql = "SELECT COUNT(*) FROM web_reports WHERE status='Submited'";
		$all = $pdo->prepare($sql);
...
<div class="table-responsive">
    ...
    ?>
    		...
    		<!-- Modal -->
    		<div class="modal fade report-modal1" id="<?php echo $index; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $row["id"]; ?>label" aria-hidden="true">
    ...
    opote to afinw xima gia tin ora, BASIC FUNCTIONALITY ITHELES PARTO -->
    				<div class="small-map-data hidden">
    					<span data-lat1="<?php echo $row['latitude']; ?>"></span>
    					<span data-long1="<?php echo $row['longitude']; ?>"></span>
    				</div>
    				...
    				<div class="modalform">
    					...
    					<div class="form-group">
							<button class="reportOpenBtn btn btn-danger form-control" name="markOpen" style="margin-bottom:5px">Open Report</button>
    					</div>
    				</div>
    			</div>
